...
Partial Class Form2
    ...
    Private Sub InitializeComponent()
        ...
        LblFormTitle.ForeColor = Color.FromArgb(CByte(255), CByte(200), CByte(0))
        ...
        LblFormSub.Font = New Font("Segoe UI", 9.0F)
        LblFormSub.ForeColor = Color.FromArgb(CByte(160), CByte(160), CByte(200))
        LblFormSub.Location = New Point(18, 48)
        ...
        ' PanelForm
        ' 
        PanelForm.BackColor = Color.FromArgb(CByte(30), CByte(30), CByte(50))
        ...
        LblNama.Font = New Font("Segoe UI", 10.0F, FontStyle.Bold)
        ...
        ' TxtNama
        ' 
        TxtNama.BackColor = Color.FromArgb(CByte(45), CByte(45), CByte(70))
        ...
        LblSeri.Font = New Font("Segoe UI", 10.0F, FontStyle.Bold)
        ...
        ' TxtSeri
        ' 
        TxtSeri.BackColor = Color.FromArgb(CByte(45), CByte(45), CByte(70))
        TxtSeri.BorderStyle = BorderStyle.FixedSingle
        TxtSeri.Font = New Font("Segoe UI", 10.0F)
        ...
        LblTipe.Font = New Font("Segoe UI", 10.0F, FontStyle.Bold)
        ...
        ' CmbTipe
        ' 
        CmbTipe.BackColor = Color.FromArgb(CByte(45), CByte(45), CByte(70))
        ...
        LblHarga.Font = New Font("Segoe UI", 10.0F, FontStyle.Bold)
        ...
        ' TxtHarga
        ' 
        TxtHarga.BackColor = Color.FromArgb(CByte(45), CByte(45), CByte(70))
        ...
        LblKondisi.Font = New Font("Segoe UI", 10.0F, FontStyle.Bold)
        ...
        ' CmbKondisi
        ' 
        CmbKondisi.BackColor = Color.FromArgb(CByte(45), CByte(45), CByte(70))
        ...
        ' CmbStatus
        ' 
        CmbStatus.BackColor = Color.FromArgb(CByte(45), CByte(45), CByte(70))
        ...
        LblTahun.Font = New Font("Segoe UI", 10.0F, FontStyle.Bold)
        ...
        ' NudTahun
        ' 
        NudTahun.BackColor = Color.FromArgb(CByte(45), CByte(45), CByte(70))
        NudTahun.Font = New Font("Segoe UI", 10.0F)
        ...
        LblDeskripsi.Font = New Font("Segoe UI", 10.0F, FontStyle.Bold)
        ...
        ' TxtDeskripsi
        ' 
        TxtDeskripsi.BackColor = Color.FromArgb(CByte(45), CByte(45), CByte(70))
        ...
        ' PanelBottom
        ' 
        PanelBottom.BackColor = Color.FromArgb(CByte(20), CByte(20), CByte(35))
        ...
        ' BtnSimpan
        ' 
        BtnSimpan.BackColor = Color.FromArgb(CByte(255), CByte(200), CByte(0))
        BtnSimpan.FlatAppearance.BorderSize = 0
        BtnSimpan.FlatStyle = FlatStyle.Flat
        BtnSimpan.Font = New Font("Segoe UI", 11.0F, FontStyle.Bold)
        ...
        ' BtnBatal
        ' 
        BtnBatal.BackColor = Color.FromArgb(CByte(80), CByte(80), CByte(110))
        BtnBatal.FlatAppearance.BorderSize = 0
        BtnBatal.FlatStyle = FlatStyle.Flat
        BtnBatal.Font = New Font("Segoe UI", 11.0F, FontStyle.Bold)
        ...
        ' Form2
        ' 
        BackColor = Color.FromArgb(CByte(30), CByte(30), CByte(50))
