...
--   POSTTEST 5 - Dengan Tabel Relasi tbtransaksi
...
-- Buat tabel koleksi (tabel utama)
...
-- ============================================================
--   TABEL BARU: tbtransaksi (berelasi dengan tbkoleksi)
--   Menyimpan riwayat transaksi (beli/jual) koleksi
-- ============================================================
CREATE TABLE IF NOT EXISTS tbtransaksi (
    id              INT AUTO_INCREMENT PRIMARY KEY,
    koleksi_id      INT          NOT NULL,
    jenis_transaksi VARCHAR(20)  NOT NULL DEFAULT 'Beli',  -- 'Beli' atau 'Jual'
    harga_transaksi BIGINT       NOT NULL DEFAULT 0,
    tanggal         DATE         NOT NULL,
    nama_penjual    VARCHAR(150) DEFAULT '',
    nama_pembeli    VARCHAR(150) DEFAULT '',
    catatan         TEXT,
    created_at      TIMESTAMP    DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (koleksi_id) REFERENCES tbkoleksi(id) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- ============================================================
--   DATA CONTOH - tbkoleksi
-- ============================================================
...
-- ============================================================
--   DATA CONTOH - tbtransaksi
-- ============================================================
INSERT INTO tbtransaksi (koleksi_id, jenis_transaksi, harga_transaksi, tanggal, nama_penjual, nama_pembeli, catatan) VALUES
(1, 'Beli',  400000, '2024-01-10', 'Tokopedia Seller A', 'Pemilik', 'Kondisi minus sedikit, tapi lengkap'),
(2, 'Beli',  650000, '2024-02-15', 'Shopee Official',    'Pemilik', 'Beli baru, sealed box'),
(3, 'Beli',  350000, '2024-03-05', 'Facebook Marketplace','Pemilik', 'Second hand, mulus'),
(9, 'Jual',  300000, '2024-04-20', 'Pemilik',            'Budi Santoso', 'Dijual karena dobel koleksi'),
(5, 'Beli',  480000, '2024-05-11', 'Carousell User',     'Pemilik', 'Lengkap dengan kotak asli');
